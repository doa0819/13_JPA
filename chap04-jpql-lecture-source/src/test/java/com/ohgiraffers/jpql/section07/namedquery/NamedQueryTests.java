...
public class NamedQueryTests {
    ...
    *     (동적으로 만들어질 쿼리를 위한 조건식 이나 반복문 -> 자바 코드를 이용할 수 있다.)
    *   [정적 쿼리]
    ...
    * */
    ...
    @DisplayName("NamedQuery 이용한 나 홀로 부분조회 테스트")
    @Test
    void testSingleNamedQuery(){

        String menuName = "열무김치라떼";
        int categoryCode = 8;

        List<Menu> menuList = repository.selectSingleNamedQuery(menuName, categoryCode);
